...
export default function DeveloperRecommendationsPage() {
  ...
  const acknowledgeRecommendation = async (recommendationId: string) => {
    ...
    try {
      await api.post(`/recommendations/${recommendationId}/acknowledge`);
        ...
        <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-muted-foreground">
              Every completed contributor analysis is turned into one action
              path: mentorship, learning path, or focused docs review.
            </p>
          </div>
          <Button
            variant="outline"
          ...
          <Card className="border-dashed border-border/60 bg-background/70">
            <CardContent className="p-10 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Trigger contributor analysis from the GitHub dashboard, then
                come back here to review generated actions.
              </p>
            </CardContent>
          </Card>
        ) : (
              ...
              return (
                ...
                >
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Badge
                          variant="outline"
                          className={
                            typeBadgeTone[recommendation.recommendation_type]
                          }
                        >
                        ...
                        <Badge
                          variant="outline"
                          className={
                            statusTone[recommendation.status] || statusTone.open
                          }
                        >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    recommendation.learning_path?.steps?.length ? (
                      <div className="rounded-2xl border border-cyan-500/30 bg-cyan-500/5 p-4">
                        <p className="flex items-center gap-2 text-sm font-semibold text-cyan-700">
                          ...
                          {recommendation.learning_path.durationWeeks || 0}{" "}
                          weeks)
                        </p>
                    ...
                    {recommendation.weakness_snapshot?.topWeaknesses?.length ? (
                      <div className="flex flex-wrap gap-2">
